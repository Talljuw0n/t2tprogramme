      ...
      <div className="wrap" style={{ position:"relative", zIndex:1, padding: m?"0":"0 80px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns: m?"1fr":"repeat(3,1fr)", gap: m?20:24 }}>
          {[
            ...
            {num:"02",title:"Market Access and Buyer Linkage",desc:"Buyer connections, ECOWAS region, US, UK and Canada market access, and full trade documentation.",dur:"Lagos · Abuja"},
